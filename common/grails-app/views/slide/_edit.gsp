...
<div class="modal fade" id="editSlideModal${instance.id}" tabindex="-1" role="dialog" aria-labelledby="editSlideModal${instance.id}Title" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <g:form name="editSlideForm${instance.id}" url="[controller:params.controller, action: 'update', id:instance.id]" class="ajaxForm">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="editSlideModal${instance.id}Title">信息修改</h4>
                </div>
