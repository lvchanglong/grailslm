...
class FunctionController {
    ...
    def show(Long id) {
        respond functionService.get(id)
    }
    ...
    def save(Function function) {
        ...
        try {
            ...
            if(!multipartFile.empty) {
                function.properties = [filename:multipartFile.getOriginalFilename(), data:[bytes:multipartFile.getBytes()]]
            }
    ...
    */
    ...
    def c1() {
        ...
        def instanceList = Function.where {
