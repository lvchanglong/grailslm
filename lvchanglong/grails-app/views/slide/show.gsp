        ...
        <div id="show-slide" class="content scaffold-show" role="main">
            ...
            <ol class="property-list slide">
                ...
                <li class="fieldcontain">
                    ...
                    <div class="property-value" aria-labelledby="zindex-label">${slide.zindex}</div>
                </li>
                <li class="fieldcontain">
                    <span id="dataname-label" class="property-label">Dataname</span>
                    <div class="property-value" aria-labelledby="dataname-label">${slide.dataname}</div>
                </li>
                <li class="fieldcontain">
