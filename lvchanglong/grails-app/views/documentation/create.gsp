...
<html>
    ...
    <body>
        <a href="#create-documentation" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-documentation" class="content scaffold-create" role="main">
            ...
            <g:uploadForm resource="${this.documentation}" method="POST">
                <fieldset class="form">
