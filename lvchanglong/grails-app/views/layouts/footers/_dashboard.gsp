...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2">
            <footer>
                <p class="pull-right"><a href="#" style="display:block;margin-top:10px;">返回顶部</a></p>
                <p style="text-align:center;">
                    <span style="font-size:26px;vertical-align:middle;">&copy;</span>2018-${new Date().format("yyyy")}，吕常龙，版权所有
                    <a href="http://www.miitbeian.gov.cn" target="_blank" rel="nofollow" style="color:#333;margin:0 10px;">辽ICP备14005125号</a>
